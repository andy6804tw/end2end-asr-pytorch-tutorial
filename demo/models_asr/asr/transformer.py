...
# from lstm_utils import LM
import os
import numpy as np
import math

from models_asr.asr import constant

# from utils_asr import calculate_metrics
# from models_asr.asr.utils_asr import calculate_lm_score
from models_asr.common_layers import MultiHeadAttention, PositionalEncoding, PositionwiseFeedForward, PositionwiseFeedForwardWithConv, get_subsequent_mask, get_non_pad_mask, get_attn_key_pad_mask, get_attn_pad_mask, pad_list
...
class Transformer(nn.Module):
    ...
    def evaluate2(self, padded_input, input_lengths,  beam_search=False, beam_width=0, beam_nbest=0, lm=None, lm_rescoring=False, lm_weight=0.1, c_weight=1, verbose=False):
        """
        args:
            padded_input: B x T x D
            input_lengths: B
